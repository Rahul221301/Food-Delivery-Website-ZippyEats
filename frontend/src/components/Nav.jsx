    ...
    return (
      ...
      ======================= */}
            {showSearch && userData.role === "user" && (
                <div
                    ref={searchRef}
                    className="w-[90%] h-[70px] bg-white shadow-xl rounded-lg items-center gap-[20px] flex fixed top-[80px] left-[5%] md:hidden"
                >
                    <div className="flex items-center w-[30%] overflow-hidden gap-[10px] px-[10px] border-r-[2px] border-gray-400">
                        <FaLocationDot size={25} className="text-[#ff4d2d]" />
                        <div className="w-[80%] truncate text-gray-600">{currentCity}</div>
            ...
            <div className="flex items-center gap-4">
                ...
                {userData.role === "owner" ? (
                    <>
                        ...
                        <button
                            className="flex items-center gap-2 cursor-pointer relative px-3 py-1 rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium"
